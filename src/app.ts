      ...
      @if (navItems.length === 0 || forceShowBaseRootApp) {
        <mat-card class="m-2">
          <mat-card-content>
            ...
            Name: my-awesome-command-line-tool<br />
...
export class MyAwesomeCommandLineToolApp implements OnInit {
...
//#region  my-awesome-command-line-tool api service
...
//#region  my-awesome-command-line-tool routes
//#region @browser
...
//#region  my-awesome-command-line-tool app configs
//#region @browser
export const MyAwesomeCommandLineToolAppConfig: ApplicationConfig = {
  providers: [
    provideZonelessChangeDetection(),
    {
      provide: TAON_CONTEXT,
      useFactory: () => MyAwesomeCommandLineToolContext,
    },
    providePrimeNG({
      theme: {
        preset: Aura,
    ...
    }),
    {
      ...
      multi: true,
      useFactory: () => MyAwesomeCommandLineToolStartFunction,
    },
    provideBrowserGlobalErrorListeners(),
    // remove withHashLocation() to use SSR
    provideRouter(
      MyAwesomeCommandLineToolClientRoutes,
      withHashLocation(),
      withComponentInputBinding(),
    ),
...
export const MyAwesomeCommandLineToolServerConfig: ApplicationConfig = {
  providers: [
    provideServerRendering(withRoutes(MyAwesomeCommandLineToolServerRoutes)),
  ],
};

export const MyAwesomeCommandLineToolConfig = mergeApplicationConfig(
  MyAwesomeCommandLineToolAppConfig,
  MyAwesomeCommandLineToolServerConfig,
);
//#endregion
//#endregion
...
//#region  my-awesome-command-line-tool migration
...
//#region  my-awesome-command-line-tool start function
export const MyAwesomeCommandLineToolStartFunction = async (
  startParams?: Taon.StartParams,
): Promise<void> => {
  await MyAwesomeCommandLineToolContext.initialize();
...
export default MyAwesomeCommandLineToolStartFunction;
//#endregion
